 ...
 */
class Rubrique extends \MyApp\EspritBundle\Entity\Rubrique implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSousrubriques($sousrubriques);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'position', 'state', 'title', 'menu');
    }
